...
package com.mycompany.mycalculator2;
  
import java.awt.*;  
import java.awt.event.*;   
  
public class MyCalculator2 extends Frame  
{  
...
///////////////////////////  
MyCalculator2(String frameText)//constructor  
{  
super(frameText);  
...
{  
new MyCalculator2("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, MyCalculator2 clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, MyCalculator2 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(MyCalculator2.getFormattedText(tempd));}  
...
cl.displayLabel.setText(MyCalculator2.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, MyCalculator2 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(MyCalculator2.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, MyCalculator2 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
